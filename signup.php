...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($result){
      ...
      $showpass = "Password does not match";
    }
    }
}
?>
...
if($showalert == true){
    ...
    <strong>Congratulation!</strong> Your data has been succesfully submited
                ...
                <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                    <div class="card" style="border-radius: 15px;">
                        <div class="card-body p-3">
                            ...
                            <form action="/MyPhp/Foram-app/signup.php" method="POST">
